...
<main>
  ...
  <div class="grid grid-cols-3 grid-rows-2 ">
    ...
    <div class="h-max-[60%] z-10 bg-secondary-100 col-start-2 row-start-2 row-span-full text-slate-50 self-end p-4 overflow-hidden m-auto relative mb-[430px] mt-[-270px]">

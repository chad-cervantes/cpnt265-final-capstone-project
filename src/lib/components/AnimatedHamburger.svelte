...
<button on:click={onClick} aria-expanded={open} aria-label={ariaLabel} class="hover:bg-pink-300 border border-none rounded-[20px] transition ease-linear duration-150 ml-[1rem]">
  <svg class:open viewBox="0 0 100 100" fill="none" stroke="currentColor" stroke-width='5' {width}>
    ...
    <path 
    class="top"
    d="m 30,33 h 40 c 3.722839,0 7.5,3.126468 7.5,8.578427 0,5.451959 -2.727029,8.4215373 h -20"/>
    ...
    <path 
    class="bottom"
    d="m 70,67 h -40 c 0,0 -7.5,-0.802118 -7.5,-8.365747 0,-7.563629 7.5,-8.634253 h 20"/>
...
<style>
  ...
  .top {
    ...
    transition: stroke-dashoffset transform var(--transition-duration);
